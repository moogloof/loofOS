...
} __attribute__((packed)) gdt[GDT_LIMIT] = {0}; // GDT buffer
...
void init_gdt() {
	...
	// Set null descriptor
	gdt[0] = (struct gdt_segment_desc){0};
	// Set kernel code
	gdt[1] = (struct gdt_segment_desc){.limit1 = 0xffff, .base1 = 0, .a = 0, .rw = 1, .dc = 0, .e = 1, .s = 1, .dpl = 0, .p = 1, .limit2 = 0xf, .zero = 0, .l = 0, .db = 1, .g = 1, .base2 = 0};
	// Set kernel data
	gdt[2] = (struct gdt_segment_desc){.limit1 = 0xffff, .base1 = 0, .a = 0, .rw = 1, .dc = 0, .e = 0, .s = 1, .dpl = 0, .p = 1, .limit2 = 0xf, .zero = 0, .l = 0, .db = 1, .g = 1, .base2 = 0};
	// Set user code
	gdt[3] = (struct gdt_segment_desc){.limit1 = 0xffff, .base1 = 0, .a = 0, .rw = 1, .dc = 0, .e = 1, .s = 1, .dpl = 3, .p = 1, .limit2 = 0xf, .zero = 0, .l = 0, .db = 1, .g = 1, .base2 = 0};
	// Set user data
	gdt[4] = (struct gdt_segment_desc){.limit1 = 0xffff, .base1 = 0, .a = 0, .rw = 1, .dc = 0, .e = 0, .s = 1, .dpl = 3, .p = 1, .limit2 = 0xf, .zero = 0, .l = 0, .db = 1, .g = 1, .base2 = 0};

	// Set TSS block
	tss.ss0 = 0x10;
	tss.esp0 = 0xd0000000 - 4;
	tss.iopb = sizeof(tss);
